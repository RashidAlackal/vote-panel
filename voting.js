...
function showVotedScreen(candidateData) {
    ...
    if (candidateData) {
        ...
        if (wardElement) {
            const displayText = `${candidateData.ballotType.toUpperCase()} : ${candidateData.number}`;
...
function getCandidateData(row) {
    ...
    if (nameElement) {
        ...
        if (candidateName === 'ശെജിനി ഉണ്ണി') {
            name = 'ശെജിനി ഉണ്ണി';
            englishName = 'SEJINI UNNI';
            photo = 'assets/candid.png';
            symbol = 'assets/ladder1.svg';
        } else if (candidateName === 'ദേവിക മോഹന്‍') {
            name = 'ദേവിക മോഹന്‍';
            englishName = 'DEVIKA MOHAN';
            photo = 'assets/candid2.png';
            symbol = 'assets/ladder2.svg';
        } else if (candidateName === 'നിഖില്‍ ദാസ്') {
            name = 'നിഖില്‍ ദാസ്';
            englishName = 'NIKHIL DAS';
